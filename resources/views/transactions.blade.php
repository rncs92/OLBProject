                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    @foreach($transactions as $transaction)
                        ...
                        <span class="
                            ...
                            dark:text-muted-100
                          ">
                                {{ $transaction->fromUser->name}} {{ $transaction->fromUser->surname }}
                            </td>
                            <td class="py-2 px-4">
                        <span class="
                            font-sans
                            ...
                            dark:text-muted-100
                          ">
                                {{ $transaction->toUser->name}} {{ $transaction->toUser->surname }}
                            </td>
                            <td class="py-2 px-4">
                        <span class="
                            inline-block
                        ...
                        <span class="
                          ...
                          {{ $transaction->receiver_account_number }}
                            ...
                            <p class="font-extrabold">{{ $transaction->amount }} {{ $transaction->currency}}</p>
                          </span>
                                </div>
                            </td>
                            <td class="py-2 px-4">
